...
local objects = {}
local themes = {
	Background = Color3.fromRGB(31, 30, 46),
	Glow = Color3.fromRGB(55, 74, 251),
	Accent = Color3.fromRGB(55, 74, 251),
	LightContrast = Color3.fromRGB(40, 42, 60),
	DarkContrast = Color3.fromRGB(40, 42, 60),  
